...
local function Precombat ()
  ...
  -- mirror_image
  if S.MirrorImage:IsCastable() and Target:Level() == Player:Level() + 2 and (Player:IsInRaidArea() or Player:IsInDungeonArea()) or Target:Level() == Player:Level() + 1 and not Player:IsInRaidArea() and not Player:IsInDungeonArea() and Settings.Arcane.MirrorImagesBeforePull then
...
local function Aoe ()
  ...
  if Target:Level() == Player:Level() + 2 and (Player:IsInRaidArea() or Player:IsInDungeonArea()) or Target:Level() == Player:Level() + 1 and not Player:IsInRaidArea() and not Player:IsInDungeonArea() and S.ArcanePower:IsCastable() and Player:BuffDown(S.RuneofPowerBuff) and ((S.TouchoftheMagi:CooldownRemains() > var_ap_max_delay and Player:ArcaneCharges() == Player:ArcaneChargesMax()) or (S.TouchoftheMagi:CooldownRemains() == 0 and Player:ArcaneCharges() <= var_totm_max_charges)) then
  ...
  if Target:Level() == Player:Level() + 2 and (Player:IsInRaidArea() or Player:IsInDungeonArea()) or Target:Level() == Player:Level() + 1 and not Player:IsInRaidArea() and not Player:IsInDungeonArea() and S.PresenceofMind:IsCastable() and Player:DebuffDown(S.PresenceofMind) and Player:BuffUp(S.Deathborne) and Target:DebuffUp(S.TouchoftheMagi) and S.TouchoftheMagi:CooldownRemains() <= (2 * S.ArcaneBlast:ExecuteTime()) + Player:GCDRemains() then
...
local function Opener ()
  ...
  --arcane_power
  if Target:Level() == Player:Level() + 2 and (Player:IsInRaidArea() or Player:IsInDungeonArea()) or Target:Level() == Player:Level() + 1 and not Player:IsInRaidArea() and not Player:IsInDungeonArea() and S.ArcanePower:IsCastable() then
  ...
  if Target:Level() == Player:Level() + 2 and (Player:IsInRaidArea() or Player:IsInDungeonArea()) or Target:Level() == Player:Level() + 1 and not Player:IsInRaidArea() and not Player:IsInDungeonArea() and S.RuneofPower:IsCastable() and Player:BuffDown(S.RuneofPowerBuff) and not S.ArcanePower:IsCastable() then
    if HR.Cast(S.RuneofPower, Settings.Arcane.GCDasOffGCD.RuneOfPower) then return "rune_of_power opener 10"; end
  end
  --presence_of_mind
  if Target:Level() == Player:Level() + 2 and (Player:IsInRaidArea() or Player:IsInDungeonArea()) or Target:Level() == Player:Level() + 1 and not Player:IsInRaidArea() and not Player:IsInDungeonArea() and S.PresenceofMind:IsCastable() and Player:BuffDown(S.PresenceofMind) then
...
local function AMSpam ()
  ...
  if Target:Level() == Player:Level() + 2 and (Player:IsInRaidArea() or Player:IsInDungeonArea()) or Target:Level() == Player:Level() + 1 and not Player:IsInRaidArea() and not Player:IsInDungeonArea() and S.RuneofPower:IsCastable() and not S.ArcanePower:IsCastable() and Player:BuffDown(S.RuneofPowerBuff) and S.ArcanePower:CooldownRemains() > 0 then
  ...
  if (Target:Level() == Player:Level() + 2 and (Player:IsInRaidArea() or Player:IsInDungeonArea()) or Target:Level() == Player:Level() + 1 and not Player:IsInRaidArea() and not Player:IsInDungeonArea() or EnemiesCount10ySplash > 2 ) and S.TouchoftheMagi:IsCastable() and not Player:IsCasting(S.TouchoftheMagi) and (Player:IsCasting(S.RuneofPower) or (not Player:IsCasting() and Player:PrevGCD(1,S.RuneOfPower)))
  ...
  if Target:Level() == Player:Level() + 2 and (Player:IsInRaidArea() or Player:IsInDungeonArea()) or Target:Level() == Player:Level() + 1 and not Player:IsInRaidArea() and not Player:IsInDungeonArea() and S.ArcanePower:IsCastable() and Player:BuffDown(S.RuneofPowerBuff) and S.TouchoftheMagi:CooldownRemains() > var_ap_max_delay then
...
local function APL()
  ...
  -- Shield
  if S.PrismaticBarrier:IsReady() and not Player:IsInDungeonArea() and not Player:IsInRaidArea() then
    if HR.Cast(S.PrismaticBarrier) then return "Cast Prismatic Barrier"; end
  end
  ...
  if Everyone.TargetIsValid() and (not Player:IsChanneling() or Player:IsChanneling() and Player:ChannelRemains() < 0.2 or Player:IsChanneling() and Player:ManaPercentage() > 99) then
    ...
    if HR.AoEON() and MeleeEnemies10yCount > 2 then
