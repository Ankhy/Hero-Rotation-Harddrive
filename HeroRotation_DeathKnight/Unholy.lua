...
local function APL()
  ...
  if Everyone.TargetIsValid() then
    ...
    if (true and Target:Level() == Player:Level() + 2 and (Player:IsInRaidArea() or Player:IsInDungeonArea()) or Target:Level() == Player:Level() + 1 and not Player:IsInRaidArea() and not Player:IsInDungeonArea()) then
